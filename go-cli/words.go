...
func registerSDKWords(r *eng.Registry, client *sdk.ColombiaPublicSDK) {
...
func runOp(client *sdk.ColombiaPublicSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
