// Command ColombiaPublic-mcp is an MCP server exposing the ColombiaPublic
// SDK as MCP tools.
//
// Two tools are registered:
//
//	ColombiaPublic_list  — list records of an entity
//	ColombiaPublic_load  — load a single record of an entity
//
