...
class DepartmentEntity
  ...
  def make
    opts = @_entopts.dup
    DepartmentEntity.new(@_client, opts)
  end
  ...
  #   as an empty match, so client.Department.load works with no args).
  ...
  #
  # @param reqmatch [DepartmentListMatch, Hash, nil] match filter (any subset of
  #   Department fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
