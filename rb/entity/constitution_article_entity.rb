...
class ConstitutionArticleEntity
  ...
  def make
    opts = @_entopts.dup
    ConstitutionArticleEntity.new(@_client, opts)
  end
  ...
  # @return [ConstitutionArticle, Hash] the current ConstitutionArticle data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ConstitutionArticle fields)
  def match_get
  ...
  #
  # @param reqmatch [ConstitutionArticleLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.ConstitutionArticle.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [ConstitutionArticle, Hash] the loaded ConstitutionArticle; raises ColombiaPublicError on failure
  ...
  #
  # @param reqmatch [ConstitutionArticleListMatch, Hash, nil] match filter (any subset of
  #   ConstitutionArticle fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<ConstitutionArticle>, Array] the matching ConstitutionArticle items; raises ColombiaPublicError on failure
