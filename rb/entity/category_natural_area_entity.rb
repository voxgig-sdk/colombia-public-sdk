...
class CategoryNaturalAreaEntity
  ...
  def make
    opts = @_entopts.dup
    CategoryNaturalAreaEntity.new(@_client, opts)
  end
  ...
  # @return [CategoryNaturalArea, Hash] the current CategoryNaturalArea data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of CategoryNaturalArea fields)
  def match_get
  ...
  #
  # @param reqmatch [CategoryNaturalAreaListMatch, Hash, nil] match filter (any subset of
  #   CategoryNaturalArea fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<CategoryNaturalArea>, Array] the matching CategoryNaturalArea items; raises ColombiaPublicError on failure
