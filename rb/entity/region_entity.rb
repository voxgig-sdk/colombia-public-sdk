# ColombiaPublic SDK Region entity
...
class RegionEntity
  ...
  # @return [Region, Hash] the loaded Region; raises ColombiaPublicError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Region>, Array] the matching Region items; raises ColombiaPublicError on failure
