...
class MapEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set COLOMBIAPUBLIC_TEST_MAP_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def map_basic_setup(extra)
  ...
  entid_env_raw = ENV["COLOMBIAPUBLIC_TEST_MAP_ENTID"]
  ...
  idmap_resolved = Helpers.to_map(
    env["COLOMBIAPUBLIC_TEST_MAP_ENTID"])
