...
class CountryEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set COLOMBIA_PUBLIC_TEST_COUNTRY_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def country_basic_setup(extra)
  ...
  entid_env_raw = ENV["COLOMBIA_PUBLIC_TEST_COUNTRY_ENTID"]
  ...
  idmap_resolved = Helpers.to_map(
    env["COLOMBIA_PUBLIC_TEST_COUNTRY_ENTID"])
