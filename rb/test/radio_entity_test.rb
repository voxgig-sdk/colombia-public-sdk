...
class RadioEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set COLOMBIAPUBLIC_TEST_RADIO_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def radio_basic_setup(extra)
  ...
  entid_env_raw = ENV["COLOMBIAPUBLIC_TEST_RADIO_ENTID"]
