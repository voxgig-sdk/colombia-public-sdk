...
#      offline in seeded test mode (ColombiaPublicSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "ColombiaPublic_sdk.rb")
  SDK_CLASS = "ColombiaPublicSDK"
