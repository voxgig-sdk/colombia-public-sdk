# ColombiaPublic SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ColombiaPublicSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ColombiaPublicSDK(...) and ColombiaPublicSDK.test(...) become
#      ColombiaPublicSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "colombiapublic_sdk"
_SDK_CLASS = "ColombiaPublicSDK"
...
_ENTITIES = {
    "Airport": "airport",
    "CategoryNaturalArea": "category_natural_area",
    "ConstitutionArticle": "constitution_article",
    "Country": "country",
    "Department": "department",
    "Holiday": "holiday",
    "InvasiveSpecie": "invasive_specie",
    "Map": "map",
    "NativeCommunity": "native_community",
    "NaturalArea": "natural_area",
    "President": "president",
    "Radio": "radio",
    "Region": "region",
    "TouristicAttraction": "touristic_attraction",
    "TypicalDish": "typical_dish",
}
