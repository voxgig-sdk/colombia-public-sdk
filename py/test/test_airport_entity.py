    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set COLOMBIA_PUBLIC_TEST_AIRPORT_ENTID JSON to run live")
        client = setup["client"]
        ...
        airport_ref01_data_dt0_load_result = helpers.to_map(runner.entity_data(airport_ref01_data_dt0_loaded))
...
def _airport_basic_setup(extra):
    ...
    idmap_resolved = helpers.to_map(
        env.get("COLOMBIA_PUBLIC_TEST_AIRPORT_ENTID"))
