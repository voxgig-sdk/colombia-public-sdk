...
class NativeCommunityEntity:
    ...
    def load(self, reqmatch: NativeCommunityLoadMatch, ctrl=None) -> NativeCommunity:
    ...
    def list(self, reqmatch: NativeCommunityListMatch, ctrl=None) -> list[NativeCommunity]:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "list",
            "ctrl": ctrl,
