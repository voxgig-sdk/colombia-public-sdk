...
class TouristicAttractionEntity:
    ...
    def load(self, reqmatch: TouristicAttractionLoadMatch, ctrl=None) -> TouristicAttraction:
    ...
    def list(self, reqmatch: TouristicAttractionListMatch, ctrl=None) -> list[TouristicAttraction]:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "list",
            "ctrl": ctrl,
