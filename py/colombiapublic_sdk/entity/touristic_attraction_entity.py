...
from colombiapublic_sdk.colombiapublic_types import (
    TouristicAttraction,
...
class TouristicAttractionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return TouristicAttractionEntity(self._client, opts)
    ...
    def data_get(self) -> TouristicAttraction:
    ...
    def match_get(self) -> TouristicAttraction:
    ...
    def load(self, reqmatch=None, ctrl=None) -> TouristicAttraction:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.TouristicAttraction().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[TouristicAttraction]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.TouristicAttraction().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
        ctx = utility.make_context({
            "opname": "list",
