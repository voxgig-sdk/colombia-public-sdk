...
class CategoryNaturalAreaEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return CategoryNaturalAreaEntity(self._client, opts)
    ...
    def data_get(self) -> CategoryNaturalArea:
    ...
    def match_get(self) -> CategoryNaturalArea:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[CategoryNaturalArea]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.CategoryNaturalArea().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
