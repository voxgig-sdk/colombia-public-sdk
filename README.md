...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/colombia-public` | `npm install @voxgig-sdk/colombia-public` |
| Python | `voxgig-sdk-colombia-public` | `pip install voxgig-sdk-colombia-public` |
| PHP | `voxgig-sdk/colombia-public` | `composer require voxgig-sdk/colombia-public` |
| Golang | `github.com/voxgig-sdk/colombia-public-sdk/go` | `go get github.com/voxgig-sdk/colombia-public-sdk/go` |
| Ruby | `voxgig-sdk-colombia-public` | `gem install voxgig-sdk-colombia-public` |
| Lua | `voxgig-sdk-colombia-public` | `luarocks install voxgig-sdk-colombia-public` |
