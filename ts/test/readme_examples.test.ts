...
//     (\`new ColombiaPublicSDK(...)\` / \`ColombiaPublicSDK.test(...)\` become
//     \`ColombiaPublicSDK.test({ entity: ... })\`), transpiled to JS, and run
...
const SDK_NAME = 'ColombiaPublicSDK'
...
const TEST_SEED = {"entity":{"airport":{"test01":{"id":"test01"}},"category_natural_area":{"test01":{"id":"test01"}},"constitution_article":{"test01":{"id":"test01"}},"country":{"test01":{"id":"test01"}},"department":{"test01":{"id":"test01"}},"holiday":{"test01":{"id":"test01"}},"invasive_specie":{"test01":{"id":"test01"}},"map":{"test01":{"id":"test01"}},"native_community":{"test01":{"id":"test01"}},"natural_area":{"test01":{"id":"test01"}},"president":{"test01":{"id":"test01"}},"radio":{"test01":{"id":"test01"}},"region":{"test01":{"id":"test01"}},"touristic_attraction":{"test01":{"id":"test01"}},"typical_dish":{"test01":{"id":"test01"}}}}
...
// rewrite real client construction (\`new ColombiaPublicSDK(...)\` and any
// \`ColombiaPublicSDK.test(...)\`) to a seeded test-mode client, and give
...
function rewriteForRun(code: string): string {
  ...
  out = out.replace(/new\s+ColombiaPublicSDK\s*\([^)]*\)/g, () => SEEDED_CTOR)
  out = out.replace(/ColombiaPublicSDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR)
