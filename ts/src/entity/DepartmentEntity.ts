...
class DepartmentEntity extends ColombiaPublicEntityBase<Department> {

  constructor(client: ColombiaPublicSDK, entopts: any) {
    super(client, entopts)
    this.name = 'department'
    this.name_ = 'department'
    this.Name = 'Department'
  }


  make(this: DepartmentEntity) {
    return new DepartmentEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: DepartmentLoadMatch, ctrl?: Control): Promise<DepartmentEntity> {
