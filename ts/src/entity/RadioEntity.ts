...
class RadioEntity extends ColombiaPublicEntityBase<Radio> {
  ...
  make(this: RadioEntity) {
    return new RadioEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: RadioLoadMatch, ctrl?: Control): Promise<RadioEntity> {
  ...
  async list(this: any, reqmatch?: RadioListMatch, ctrl?: Control): Promise<RadioEntity[]> {
