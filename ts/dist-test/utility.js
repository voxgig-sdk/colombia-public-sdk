...
function envOverride(m) {
    if ('TRUE' === process.env.COLOMBIA_PUBLIC_TEST_LIVE ||
        'TRUE' === process.env.COLOMBIA_PUBLIC_TEST_OVERRIDE) {
    ...
    m.COLOMBIA_PUBLIC_TEST_EXPLAIN = process.env.COLOMBIA_PUBLIC_TEST_EXPLAIN || m.COLOMBIA_PUBLIC_TEST_EXPLAIN;
    return m;
}
