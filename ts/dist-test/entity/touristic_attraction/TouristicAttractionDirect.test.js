...
(0, node_test_1.describe)('TouristicAttractionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.ColombiaPublicSDK({
    ...
    (0, node_test_1.test)('direct-load-touristic_attraction', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-touristic_attraction', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-touristic_attraction', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-touristic_attraction', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function liveScenariosActive() { return false && process.env.COLOMBIA_PUBLIC_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.ColombiaPublicSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['COLOMBIA_PUBLIC_TEST_TOURISTIC_ATTRACTION_ENTID'];
    ...
    const client = new __1.ColombiaPublicSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=TouristicAttractionDirect.test.js.map