...
(0, node_test_1.describe)('CategoryNaturalAreaDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-category_natural_area', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-category_natural_area', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['COLOMBIA_PUBLIC_TEST_CATEGORY_NATURAL_AREA_ENTID'];
...
//# sourceMappingURL=CategoryNaturalAreaDirect.test.js.map