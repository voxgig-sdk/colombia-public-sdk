...
(0, node_test_1.describe)('NaturalAreaDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-natural_area', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-natural_area', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-natural_area', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-natural_area', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['COLOMBIA_PUBLIC_TEST_NATURAL_AREA_ENTID'];
...
//# sourceMappingURL=NaturalAreaDirect.test.js.map