...
(0, node_test_1.describe)('AirportDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-airport', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-airport', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'COLOMBIA_PUBLIC_TEST_AIRPORT_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['COLOMBIA_PUBLIC_TEST_AIRPORT_ENTID'];
