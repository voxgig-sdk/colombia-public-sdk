...
(0, node_test_1.describe)('RadioEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list', 'load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'radio.' + op, live))
                return;
        }
        ...
        let radio_ref01_data = Object.values(setup.data.existing.radio)[0];
        // LIST
        const radio_ref01_ent = client.Radio();
        const radio_ref01_match = {};
        const radio_ref01_list = (await radio_ref01_ent.list(radio_ref01_match)).map((e) => e.data());
        // LOAD
        const radio_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(radio_ref01_data_dt0.id === radio_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/radio/RadioTestData.json');
    ...
    let idmap = transform(['radio01', 'radio02', 'radio03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['COLOMBIA_PUBLIC_TEST_RADIO_ENTID'];
...
//# sourceMappingURL=RadioEntity.test.js.map