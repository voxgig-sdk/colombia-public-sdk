...
(0, node_test_1.describe)('HolidayDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-holiday', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-holiday', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-holiday', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-holiday', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    const env = (0, utility_1.envOverride)({
        'COLOMBIA_PUBLIC_TEST_HOLIDAY_ENTID': {},
    ...
    if (live) {
        ...
        let idmap = env['COLOMBIA_PUBLIC_TEST_HOLIDAY_ENTID'];
...
//# sourceMappingURL=HolidayDirect.test.js.map