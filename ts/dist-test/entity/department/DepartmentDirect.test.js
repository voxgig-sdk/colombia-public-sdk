...
(0, node_test_1.describe)('DepartmentDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-department', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-department', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-department', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-department', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['COLOMBIA_PUBLIC_TEST_DEPARTMENT_ENTID'];
...
//# sourceMappingURL=DepartmentDirect.test.js.map