...
(0, node_test_1.describe)('TypicalDishEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['list', 'load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'typical_dish.' + op, live))
                return;
        }
        ...
        let typical_dish_ref01_data = Object.values(setup.data.existing.typical_dish)[0];
        // LIST
        const typical_dish_ref01_ent = client.TypicalDish();
        const typical_dish_ref01_match = {};
        const typical_dish_ref01_list = (await typical_dish_ref01_ent.list(typical_dish_ref01_match)).map((e) => e.data());
        // LOAD
        const typical_dish_ref01_match_dt0 = {};
        ...
        (0, node_assert_1.default)(typical_dish_ref01_data_dt0.id === typical_dish_ref01_data.id);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/typical_dish/TypicalDishTestData.json');
    ...
    let idmap = transform(['typical_dish01', 'typical_dish02', 'typical_dish03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
...
//# sourceMappingURL=TypicalDishEntity.test.js.map