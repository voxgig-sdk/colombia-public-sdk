...
(0, node_test_1.describe)('TypicalDishDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-typical_dish', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-typical_dish', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-typical_dish', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-typical_dish', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['COLOMBIA_PUBLIC_TEST_TYPICAL_DISH_ENTID'];
...
//# sourceMappingURL=TypicalDishDirect.test.js.map