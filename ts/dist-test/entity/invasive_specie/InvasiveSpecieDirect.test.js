...
(0, node_test_1.describe)('InvasiveSpecieDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-invasive_specie', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-invasive_specie', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-invasive_specie', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-invasive_specie', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['COLOMBIA_PUBLIC_TEST_INVASIVE_SPECIE_ENTID'];
...
//# sourceMappingURL=InvasiveSpecieDirect.test.js.map