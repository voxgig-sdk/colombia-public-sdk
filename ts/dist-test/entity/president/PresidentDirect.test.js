...
(0, node_test_1.describe)('PresidentDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-president', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-president', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-president', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-president', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['COLOMBIA_PUBLIC_TEST_PRESIDENT_ENTID'];
...
//# sourceMappingURL=PresidentDirect.test.js.map