...
local PresidentEntity = {}
PresidentEntity.__index = PresidentEntity


function PresidentEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PresidentEntity)
...
function PresidentEntity:get_name()
  return self._name
end


function PresidentEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PresidentEntity.new(self._client, opts)
end
...
function PresidentEntity:mark_deleted()
  self._deleted = true
end


function PresidentEntity:deleted()
  return true == self._deleted
end


function PresidentEntity:data_set(args)
  if args ~= nil then
...
function PresidentEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PresidentEntity:match_set(args)
  if args ~= nil then
...
function PresidentEntity:match_get()
...
function PresidentEntity:stream(action, args, callopts)
...
function PresidentEntity:_run_op(ctx, post_done)
  local utility = self._utility
