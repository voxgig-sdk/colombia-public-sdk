...
function RadioEntity.new(client, entopts)
  entopts = entopts or {}
...
function RadioEntity:get_name()
  return self._name
end


function RadioEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return RadioEntity.new(self._client, opts)
end
...
function RadioEntity:mark_deleted()
  self._deleted = true
end


function RadioEntity:deleted()
  return true == self._deleted
end


function RadioEntity:data_set(args)
  if args ~= nil then
...
function RadioEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function RadioEntity:match_set(args)
  if args ~= nil then
...
function RadioEntity:match_get()
...
function RadioEntity:stream(action, args, callopts)
...
---@param reqmatch RadioLoadMatch
---@param ctrl? table
---@return Radio
---@return string? err
function RadioEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch RadioListMatch
---@param ctrl? table
---@return Radio[]
---@return string? err
function RadioEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function RadioEntity:_run_op(ctx, post_done)
  local utility = self._utility
