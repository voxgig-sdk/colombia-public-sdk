...
local TypicalDishEntity = {}
TypicalDishEntity.__index = TypicalDishEntity


function TypicalDishEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, TypicalDishEntity)
  self._name = "typical_dish"
  self._client = client
...
function TypicalDishEntity:get_name()
  return self._name
end


function TypicalDishEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return TypicalDishEntity.new(self._client, opts)
end
...
function TypicalDishEntity:mark_deleted()
  self._deleted = true
end


function TypicalDishEntity:deleted()
  return true == self._deleted
end


function TypicalDishEntity:data_set(args)
  if args ~= nil then
...
function TypicalDishEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function TypicalDishEntity:match_set(args)
  if args ~= nil then
...
function TypicalDishEntity:match_get()
...
function TypicalDishEntity:stream(action, args, callopts)
...
function TypicalDishEntity:_run_op(ctx, post_done)
  local utility = self._utility
