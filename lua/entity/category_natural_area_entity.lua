...
local CategoryNaturalAreaEntity = {}
CategoryNaturalAreaEntity.__index = CategoryNaturalAreaEntity


function CategoryNaturalAreaEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CategoryNaturalAreaEntity)
  self._name = "category_natural_area"
  self._client = client
...
function CategoryNaturalAreaEntity:get_name()
  return self._name
end


function CategoryNaturalAreaEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CategoryNaturalAreaEntity.new(self._client, opts)
end
...
function CategoryNaturalAreaEntity:mark_deleted()
  self._deleted = true
end


function CategoryNaturalAreaEntity:deleted()
  return true == self._deleted
end


function CategoryNaturalAreaEntity:data_set(args)
  if args ~= nil then
...
function CategoryNaturalAreaEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CategoryNaturalAreaEntity:match_set(args)
  if args ~= nil then
...
function CategoryNaturalAreaEntity:match_get()
...
function CategoryNaturalAreaEntity:stream(action, args, callopts)
...
function CategoryNaturalAreaEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return CategoryNaturalAreaEntity
