...
local TouristicAttractionEntity = {}
TouristicAttractionEntity.__index = TouristicAttractionEntity


function TouristicAttractionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, TouristicAttractionEntity)
  self._name = "touristic_attraction"
  self._client = client
...
function TouristicAttractionEntity:get_name()
  return self._name
end


function TouristicAttractionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return TouristicAttractionEntity.new(self._client, opts)
end
...
function TouristicAttractionEntity:mark_deleted()
  self._deleted = true
end


function TouristicAttractionEntity:deleted()
  return true == self._deleted
end


function TouristicAttractionEntity:data_set(args)
  if args ~= nil then
...
function TouristicAttractionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function TouristicAttractionEntity:match_set(args)
  if args ~= nil then
...
function TouristicAttractionEntity:match_get()
...
function TouristicAttractionEntity:stream(action, args, callopts)
...
---@param reqmatch TouristicAttractionLoadMatch
---@param ctrl? table
---@return TouristicAttraction
---@return string? err
function TouristicAttractionEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch TouristicAttractionListMatch
---@param ctrl? table
---@return TouristicAttraction[]
---@return string? err
function TouristicAttractionEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function TouristicAttractionEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return TouristicAttractionEntity
