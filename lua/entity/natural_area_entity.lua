...
local NaturalAreaEntity = {}
NaturalAreaEntity.__index = NaturalAreaEntity


function NaturalAreaEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, NaturalAreaEntity)
  self._name = "natural_area"
  self._client = client
...
function NaturalAreaEntity:get_name()
  return self._name
end


function NaturalAreaEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return NaturalAreaEntity.new(self._client, opts)
end
...
function NaturalAreaEntity:mark_deleted()
  self._deleted = true
end


function NaturalAreaEntity:deleted()
  return true == self._deleted
end


function NaturalAreaEntity:data_set(args)
  if args ~= nil then
...
function NaturalAreaEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function NaturalAreaEntity:match_set(args)
  if args ~= nil then
...
function NaturalAreaEntity:match_get()
...
function NaturalAreaEntity:stream(action, args, callopts)
...
---@param reqmatch NaturalAreaLoadMatch
---@param ctrl? table
---@return NaturalArea
---@return string? err
function NaturalAreaEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch NaturalAreaListMatch
---@param ctrl? table
---@return NaturalArea[]
---@return string? err
function NaturalAreaEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function NaturalAreaEntity:_run_op(ctx, post_done)
  local utility = self._utility
