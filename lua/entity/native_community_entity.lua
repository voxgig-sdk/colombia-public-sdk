...
local NativeCommunityEntity = {}
NativeCommunityEntity.__index = NativeCommunityEntity


function NativeCommunityEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, NativeCommunityEntity)
  self._name = "native_community"
  self._client = client
...
function NativeCommunityEntity:get_name()
  return self._name
end


function NativeCommunityEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return NativeCommunityEntity.new(self._client, opts)
end
...
function NativeCommunityEntity:mark_deleted()
  self._deleted = true
end


function NativeCommunityEntity:deleted()
  return true == self._deleted
end


function NativeCommunityEntity:data_set(args)
  if args ~= nil then
...
function NativeCommunityEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function NativeCommunityEntity:match_set(args)
  if args ~= nil then
...
function NativeCommunityEntity:match_get()
...
function NativeCommunityEntity:stream(action, args, callopts)
...
---@param reqmatch NativeCommunityLoadMatch
---@param ctrl? table
---@return NativeCommunity
---@return string? err
function NativeCommunityEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch NativeCommunityListMatch
---@param ctrl? table
---@return NativeCommunity[]
---@return string? err
function NativeCommunityEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function NativeCommunityEntity:_run_op(ctx, post_done)
  local utility = self._utility
