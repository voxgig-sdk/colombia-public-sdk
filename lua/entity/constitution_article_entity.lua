...
local ConstitutionArticleEntity = {}
ConstitutionArticleEntity.__index = ConstitutionArticleEntity


function ConstitutionArticleEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ConstitutionArticleEntity)
  self._name = "constitution_article"
  self._client = client
...
function ConstitutionArticleEntity:get_name()
  return self._name
end


function ConstitutionArticleEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ConstitutionArticleEntity.new(self._client, opts)
end
...
function ConstitutionArticleEntity:mark_deleted()
  self._deleted = true
end


function ConstitutionArticleEntity:deleted()
  return true == self._deleted
end


function ConstitutionArticleEntity:data_set(args)
  if args ~= nil then
...
function ConstitutionArticleEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ConstitutionArticleEntity:match_set(args)
  if args ~= nil then
...
function ConstitutionArticleEntity:match_get()
...
function ConstitutionArticleEntity:stream(action, args, callopts)
...
---@param reqmatch ConstitutionArticleLoadMatch
---@param ctrl? table
---@return ConstitutionArticle
---@return string? err
function ConstitutionArticleEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ConstitutionArticleListMatch
---@param ctrl? table
---@return ConstitutionArticle[]
---@return string? err
function ConstitutionArticleEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
function ConstitutionArticleEntity:_run_op(ctx, post_done)
  local utility = self._utility
...
return ConstitutionArticleEntity
