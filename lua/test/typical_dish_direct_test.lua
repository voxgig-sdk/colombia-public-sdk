...
describe("TypicalDishDirect", function()
  it("should direct-list-typical_dish", function()
    local setup = typical_dish_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-typical_dish", setup.live and "live" or "unit")
  ...
  it("should direct-load-typical_dish", function()
    local setup = typical_dish_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-typical_dish", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function typical_dish_direct_setup(mockres)
