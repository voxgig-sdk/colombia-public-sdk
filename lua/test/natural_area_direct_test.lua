...
describe("NaturalAreaDirect", function()
  it("should direct-list-natural_area", function()
    local setup = natural_area_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-natural_area", setup.live and "live" or "unit")
  ...
  it("should direct-load-natural_area", function()
    local setup = natural_area_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-natural_area", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function natural_area_direct_setup(mockres)
