-- ConstitutionArticle direct test
...
describe("ConstitutionArticleDirect", function()
  it("should direct-list-constitution_article", function()
    local setup = constitution_article_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-constitution_article", setup.live and "live" or "unit")
  ...
  it("should direct-load-constitution_article", function()
    local setup = constitution_article_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-constitution_article", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function constitution_article_direct_setup(mockres)
