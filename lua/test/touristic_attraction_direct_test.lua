-- TouristicAttraction direct test
...
describe("TouristicAttractionDirect", function()
  it("should direct-list-touristic_attraction", function()
    local setup = touristic_attraction_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-touristic_attraction", setup.live and "live" or "unit")
  ...
  it("should direct-load-touristic_attraction", function()
    local setup = touristic_attraction_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-touristic_attraction", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function touristic_attraction_direct_setup(mockres)
