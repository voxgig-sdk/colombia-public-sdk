-- CategoryNaturalArea direct test
...
describe("CategoryNaturalAreaDirect", function()
  it("should direct-list-category_natural_area", function()
    local setup = category_natural_area_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-category_natural_area", setup.live and "live" or "unit")
...
function category_natural_area_direct_setup(mockres)
