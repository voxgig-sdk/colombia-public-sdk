...
function runner.env_override(m)
  local live = runner.getenv("COLOMBIAPUBLIC_TEST_LIVE")
  local override = runner.getenv("COLOMBIAPUBLIC_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("COLOMBIAPUBLIC_TEST_EXPLAIN")
