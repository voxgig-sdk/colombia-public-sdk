...
function runner.env_override(m)
  local live = runner.getenv("COLOMBIA_PUBLIC_TEST_LIVE")
  local override = runner.getenv("COLOMBIA_PUBLIC_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("COLOMBIA_PUBLIC_TEST_EXPLAIN")
