# ColombiaPublic SDK — Agent Guide
...
**Entities** (15): `Airport`, `CategoryNaturalArea`, `ConstitutionArticle`, `Country`, `Department`, `Holiday`, `InvasiveSpecie`, `Map`, `NativeCommunity`, `NaturalArea`, `President`, `Radio`, `Region`, `TouristicAttraction`, `TypicalDish`.
