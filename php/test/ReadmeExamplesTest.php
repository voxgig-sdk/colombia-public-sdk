...
// ColombiaPublic SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ColombiaPublicSDK::test)
...
{
    private const SDK_CLASS = 'ColombiaPublicSDK';
    ...
    private const SDK_BASE = 'colombiapublic_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../colombiapublic_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
