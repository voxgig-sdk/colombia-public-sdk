...
class NativeCommunityEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set COLOMBIAPUBLIC_TEST_NATIVE_COMMUNITY_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function native_community_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("COLOMBIAPUBLIC_TEST_NATIVE_COMMUNITY_ENTID");
