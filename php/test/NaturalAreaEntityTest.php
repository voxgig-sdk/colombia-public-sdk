...
class NaturalAreaEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $seen = iterator_to_array($base->NaturalArea(null)->stream("list", null, null), false);
        ...
        if (isset($cfg["feature"]) && is_array($cfg["feature"]) && isset($cfg["feature"]["streaming"])) {
            ...
            $got = [];
            foreach ($sdk->NaturalArea(null)->stream("list", null, null) as $item) {
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set COLOMBIA_PUBLIC_TEST_NATURAL_AREA_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
        ...
        $natural_area_ref01_data_dt0_load_result = Helpers::to_map(is_object($natural_area_ref01_data_dt0_loaded) && method_exists($natural_area_ref01_data_dt0_loaded, 'data_get') ? $natural_area_ref01_data_dt0_loaded->data_get() : $natural_area_ref01_data_dt0_loaded);
...
function natural_area_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("COLOMBIA_PUBLIC_TEST_NATURAL_AREA_ENTID");
