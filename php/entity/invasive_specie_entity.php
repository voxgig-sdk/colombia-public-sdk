...
// ColombiaPublic SDK InvasiveSpecie entity
...
class InvasiveSpecieEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new InvasiveSpecieEntity($this->_client, $opts);
    }

    /**
     * @param InvasiveSpecie|array $args InvasiveSpecie data (assoc-array) to store.
     */
    ...
    /**
     * @return InvasiveSpecie|array The current InvasiveSpecie data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of InvasiveSpecie fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of InvasiveSpecie fields).
     */
    ...
    /**
     * Load a single InvasiveSpecie.
     *
     * @param InvasiveSpecieLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed InvasiveSpecieLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return InvasiveSpecie|array The loaded InvasiveSpecie as an assoc-array at the
    ...
    /**
     * List InvasiveSpecie items matching the given filter.
     *
     * @param InvasiveSpecieListMatch|array|null $reqmatch Match filter (any subset
     *   of InvasiveSpecie fields) as an assoc-array; InvasiveSpecieListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return InvasiveSpecie[]|array A list of InvasiveSpecie items as assoc-arrays at
