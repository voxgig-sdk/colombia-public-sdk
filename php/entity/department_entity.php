...
class DepartmentEntity
{
     ...
     *
     * @param DepartmentLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed DepartmentLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Department|array The loaded Department as an assoc-array at the
