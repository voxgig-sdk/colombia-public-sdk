...
// ColombiaPublic SDK Radio entity
...
class RadioEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new RadioEntity($this->_client, $opts);
    }

    /**
     * @param Radio|array $args Radio data (assoc-array) to store.
     */
    ...
    /**
     * @return Radio|array The current Radio data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Radio fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Radio fields).
     */
     ...
     * Load a single Radio.
     *
     * @param RadioLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed RadioLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Radio|array The loaded Radio as an assoc-array at the
    ...
    /**
     * List Radio items matching the given filter.
     *
     * @param RadioListMatch|array|null $reqmatch Match filter (any subset
     *   of Radio fields) as an assoc-array; RadioListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Radio[]|array A list of Radio items as assoc-arrays at
