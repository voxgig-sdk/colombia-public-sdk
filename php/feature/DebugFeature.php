...
// ColombiaPublic SDK debug feature
...
class ColombiaPublicDebugFeature extends ColombiaPublicBaseFeature
{
    ...
    private function _finish(ColombiaPublicContext $ctx, bool $ok): void
    {
