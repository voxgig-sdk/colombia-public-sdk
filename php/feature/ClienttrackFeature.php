...
// ColombiaPublic SDK clienttrack feature
...
class ColombiaPublicClienttrackFeature extends ColombiaPublicBaseFeature
{
    ...
    public function PostConstruct(ColombiaPublicContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'ColombiaPublic-SDK';
