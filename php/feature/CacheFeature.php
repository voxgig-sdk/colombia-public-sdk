...
// ColombiaPublic SDK cache feature
...
class ColombiaPublicCacheFeature extends ColombiaPublicBaseFeature
{
    ...
    private function _through(ColombiaPublicContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
