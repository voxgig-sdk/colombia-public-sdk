...
// ColombiaPublic SDK audit feature
...
class ColombiaPublicAuditFeature extends ColombiaPublicBaseFeature
{
    ...
    private function _emit(ColombiaPublicContext $ctx, string $outcome): void
    {
