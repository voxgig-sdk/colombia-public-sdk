...
// ColombiaPublic SDK proxy feature
...
class ColombiaPublicProxyFeature extends ColombiaPublicBaseFeature
{
    ...
    public function init(ColombiaPublicContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (ColombiaPublicContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
