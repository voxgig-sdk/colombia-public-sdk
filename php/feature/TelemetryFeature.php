...
// ColombiaPublic SDK telemetry feature
...
class ColombiaPublicTelemetryFeature extends ColombiaPublicBaseFeature
{
    ...
    private function _close(ColombiaPublicContext $ctx, bool $ok): void
    {
