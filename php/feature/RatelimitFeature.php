...
// ColombiaPublic SDK ratelimit feature
...
class ColombiaPublicRatelimitFeature extends ColombiaPublicBaseFeature
{
    ...
    private function _acquire(ColombiaPublicContext $ctx): void
    {
    ...
    private function _track(ColombiaPublicContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
