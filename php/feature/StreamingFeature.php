...
// ColombiaPublic SDK streaming feature
...
class ColombiaPublicStreamingFeature extends ColombiaPublicBaseFeature
{
    ...
    private function _iterate(ColombiaPublicResult $result): \Generator
    {
    ...
    private function _streamable(ColombiaPublicContext $ctx): bool
    {
