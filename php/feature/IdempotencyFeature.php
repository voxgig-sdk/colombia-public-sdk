...
// ColombiaPublic SDK idempotency feature
...
class ColombiaPublicIdempotencyFeature extends ColombiaPublicBaseFeature
{
    ...
    private function _mutating(ColombiaPublicContext $ctx): bool
    {
