...
// ColombiaPublic SDK rbac feature
...
class ColombiaPublicRbacFeature extends ColombiaPublicBaseFeature
{
    ...
    private function _required(ColombiaPublicContext $ctx): ?string
    {
    ...
    private function _reject(ColombiaPublicContext $ctx, string $required): void
    {
    ...
    private function _track(ColombiaPublicContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
