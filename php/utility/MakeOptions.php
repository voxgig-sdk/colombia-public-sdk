...
// ColombiaPublic SDK utility: make_options

class ColombiaPublicMakeOptions
{
    ...
    public static function call(ColombiaPublicContext $ctx): array
    {
        ...
        //
        // `ColombiaPublicSchema::optspec()` is built from the model:
        ...
        $optspec = ColombiaPublicSchema::optspec();
