...
// ColombiaPublic SDK utility: graphql
//
...
class ColombiaPublicGraphql
{
    ...
    // equivalent.
    public static function body(ColombiaPublicContext $ctx): mixed
    {
    ...
    public static function errors(ColombiaPublicContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
