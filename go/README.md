...
The Golang SDK for the ColombiaPublic API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/colombia-public-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/colombia-public-sdk=../path/to/github.com/voxgig-sdk/colombia-public-sdk
```
...
```
github.com/voxgig-sdk/colombia-public-sdk/
...
The root package (`github.com/voxgig-sdk/colombia-public-sdk`) re-exports everything needed
