...
const testSeed = `map[string]any{"entity": map[string]any{"airport": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "category_natural_area": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "constitution_article": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "country": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "department": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "holiday": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "invasive_specie": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "map": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "native_community": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "natural_area": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "president": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "radio": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "region": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "touristic_attraction": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "typical_dish": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
