...
func TestCategoryNaturalAreaEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		categoryNaturalAreaRef01DataRaw := vs.Items(core.ToMapAny(vs.GetPath(setup.data, "existing.category_natural_area")))
...
func category_natural_areaBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("COLOMBIA_PUBLIC_TEST_CATEGORY_NATURAL_AREA_ENTID")
	...
	idmapResolved := core.ToMapAny(env["COLOMBIA_PUBLIC_TEST_CATEGORY_NATURAL_AREA_ENTID"])
