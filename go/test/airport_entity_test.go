...
func TestAirportEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		airportRef01DataDt0LoadResult := core.ToMapAny(entityData(airportRef01DataDt0Loaded))
...
func airportBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("COLOMBIA_PUBLIC_TEST_AIRPORT_ENTID")
	...
	idmapResolved := core.ToMapAny(env["COLOMBIA_PUBLIC_TEST_AIRPORT_ENTID"])
