...
func NewPresidentEntity(client *core.ColombiaPublicSDK, entopts map[string]any) *PresidentEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PresidentEntity) GetName() string { return e.name }
...
func (e *PresidentEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PresidentEntity) Deleted() bool {
	return e.deleted
}


func (e *PresidentEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPresidentEntity(e.client, opts)
}

func (e *PresidentEntity) Data(args ...any) any {
...
func (e *PresidentEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an President; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PresidentEntity) DataTyped(data ...President) President {
	if len(data) > 0 {
		return typedFrom[President](e.Data(asMap(data[0])))
	}
	return typedFrom[President](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through President (all fields
// optional at the wire level).
func (e *PresidentEntity) MatchTyped(match ...President) President {
	if len(match) > 0 {
		return typedFrom[President](e.Match(asMap(match[0])))
	}
	return typedFrom[President](e.Match())
}
...
func (e *PresidentEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PresidentEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PresidentLoadMatch and returns an President. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PresidentEntity) LoadTyped(reqmatch PresidentLoadMatch, ctrl map[string]any) (President, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return President{}, err
	}
	return typedFrom[President](res), nil
}




func (e *PresidentEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// PresidentListMatch and returns []President. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PresidentEntity) ListTyped(reqmatch PresidentListMatch, ctrl map[string]any) ([]President, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[President](res), nil
}



func (e *PresidentEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PresidentEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PresidentEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PresidentEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
