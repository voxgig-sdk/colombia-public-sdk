...
func NewTypicalDishEntity(client *core.ColombiaPublicSDK, entopts map[string]any) *TypicalDishEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TypicalDishEntity) GetName() string { return e.name }
...
func (e *TypicalDishEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TypicalDishEntity) Deleted() bool {
	return e.deleted
}


func (e *TypicalDishEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTypicalDishEntity(e.client, opts)
}

func (e *TypicalDishEntity) Data(args ...any) any {
...
func (e *TypicalDishEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *TypicalDishEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TypicalDishEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
func (e *TypicalDishEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TypicalDishEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TypicalDishEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TypicalDishEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
