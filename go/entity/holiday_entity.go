...
func NewHolidayEntity(client *core.ColombiaPublicSDK, entopts map[string]any) *HolidayEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *HolidayEntity) GetName() string { return e.name }
...
func (e *HolidayEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *HolidayEntity) Deleted() bool {
	return e.deleted
}


func (e *HolidayEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewHolidayEntity(e.client, opts)
}

func (e *HolidayEntity) Data(args ...any) any {
...
func (e *HolidayEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Holiday; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *HolidayEntity) DataTyped(data ...Holiday) Holiday {
	if len(data) > 0 {
		return typedFrom[Holiday](e.Data(asMap(data[0])))
	}
	return typedFrom[Holiday](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Holiday (all fields
// optional at the wire level).
func (e *HolidayEntity) MatchTyped(match ...Holiday) Holiday {
	if len(match) > 0 {
		return typedFrom[Holiday](e.Match(asMap(match[0])))
	}
	return typedFrom[Holiday](e.Match())
}
...
func (e *HolidayEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *HolidayEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// HolidayLoadMatch and returns an Holiday. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *HolidayEntity) LoadTyped(reqmatch HolidayLoadMatch, ctrl map[string]any) (Holiday, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Holiday{}, err
	}
	return typedFrom[Holiday](res), nil
}




func (e *HolidayEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// HolidayListMatch and returns []Holiday. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *HolidayEntity) ListTyped(reqmatch HolidayListMatch, ctrl map[string]any) ([]Holiday, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Holiday](res), nil
}



func (e *HolidayEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *HolidayEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *HolidayEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *HolidayEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
