...
func NewNaturalAreaEntity(client *core.ColombiaPublicSDK, entopts map[string]any) *NaturalAreaEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *NaturalAreaEntity) GetName() string { return e.name }
...
func (e *NaturalAreaEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *NaturalAreaEntity) Deleted() bool {
	return e.deleted
}


func (e *NaturalAreaEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewNaturalAreaEntity(e.client, opts)
}

func (e *NaturalAreaEntity) Data(args ...any) any {
...
func (e *NaturalAreaEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an NaturalArea; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *NaturalAreaEntity) DataTyped(data ...NaturalArea) NaturalArea {
	if len(data) > 0 {
		return typedFrom[NaturalArea](e.Data(asMap(data[0])))
	}
	return typedFrom[NaturalArea](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through NaturalArea (all fields
// optional at the wire level).
func (e *NaturalAreaEntity) MatchTyped(match ...NaturalArea) NaturalArea {
	if len(match) > 0 {
		return typedFrom[NaturalArea](e.Match(asMap(match[0])))
	}
	return typedFrom[NaturalArea](e.Match())
}
...
func (e *NaturalAreaEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *NaturalAreaEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// NaturalAreaLoadMatch and returns an NaturalArea. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *NaturalAreaEntity) LoadTyped(reqmatch NaturalAreaLoadMatch, ctrl map[string]any) (NaturalArea, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return NaturalArea{}, err
	}
	return typedFrom[NaturalArea](res), nil
}




func (e *NaturalAreaEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// NaturalAreaListMatch and returns []NaturalArea. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *NaturalAreaEntity) ListTyped(reqmatch NaturalAreaListMatch, ctrl map[string]any) ([]NaturalArea, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[NaturalArea](res), nil
}



func (e *NaturalAreaEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *NaturalAreaEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *NaturalAreaEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *NaturalAreaEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
