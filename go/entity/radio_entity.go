...
func NewRadioEntity(client *core.ColombiaPublicSDK, entopts map[string]any) *RadioEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *RadioEntity) GetName() string { return e.name }
...
func (e *RadioEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *RadioEntity) Deleted() bool {
	return e.deleted
}


func (e *RadioEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewRadioEntity(e.client, opts)
}

func (e *RadioEntity) Data(args ...any) any {
...
func (e *RadioEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Radio; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *RadioEntity) DataTyped(data ...Radio) Radio {
	if len(data) > 0 {
		return typedFrom[Radio](e.Data(asMap(data[0])))
	}
	return typedFrom[Radio](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Radio (all fields
// optional at the wire level).
func (e *RadioEntity) MatchTyped(match ...Radio) Radio {
	if len(match) > 0 {
		return typedFrom[Radio](e.Match(asMap(match[0])))
	}
	return typedFrom[Radio](e.Match())
}
...
func (e *RadioEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *RadioEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// RadioLoadMatch and returns an Radio. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *RadioEntity) LoadTyped(reqmatch RadioLoadMatch, ctrl map[string]any) (Radio, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Radio{}, err
	}
	return typedFrom[Radio](res), nil
}




func (e *RadioEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// RadioListMatch and returns []Radio. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *RadioEntity) ListTyped(reqmatch RadioListMatch, ctrl map[string]any) ([]Radio, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Radio](res), nil
}



func (e *RadioEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *RadioEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *RadioEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *RadioEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
