...
type TouristicAttractionEntity struct {
	name    string
...
func NewTouristicAttractionEntity(client *core.ColombiaPublicSDK, entopts map[string]any) *TouristicAttractionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TouristicAttractionEntity) GetName() string { return e.name }
...
func (e *TouristicAttractionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TouristicAttractionEntity) Deleted() bool {
	return e.deleted
}


func (e *TouristicAttractionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTouristicAttractionEntity(e.client, opts)
}

func (e *TouristicAttractionEntity) Data(args ...any) any {
...
func (e *TouristicAttractionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *TouristicAttractionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TouristicAttractionEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
func (e *TouristicAttractionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TouristicAttractionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TouristicAttractionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TouristicAttractionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
