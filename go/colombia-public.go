...
// instead of `sdk.NewColombiaPublicSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *ColombiaPublicSDK  { return NewColombiaPublicSDK(nil) }
func Test() *ColombiaPublicSDK { return TestSDK(nil, nil) }
