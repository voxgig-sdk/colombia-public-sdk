...
from projectname_sdk.core.control import ColombiaPublicControl
...
class ColombiaPublicContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = ColombiaPublicControl()
        ...
        if isinstance(sp, ColombiaPublicSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, ColombiaPublicResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, ColombiaPublicResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return ColombiaPublicOperation({})
    ...
    def make_error(self, code, msg):
        return ColombiaPublicError(code, msg, self)
