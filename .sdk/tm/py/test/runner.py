...
class ColombiaPublicTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ColombiaPublicTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = ColombiaPublicTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = ColombiaPublicTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
