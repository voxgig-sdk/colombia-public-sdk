...
class ColombiaPublicTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ColombiaPublicTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = ColombiaPublicTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = ColombiaPublicTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
