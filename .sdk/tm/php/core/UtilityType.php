...
// ColombiaPublic SDK utility type

class ColombiaPublicUtility
{
    ...
    public static function copy(ColombiaPublicUtility $src): ColombiaPublicUtility
    {
        $u = new ColombiaPublicUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
