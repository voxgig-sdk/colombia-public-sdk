...
// ColombiaPublic SDK pipeline test
//
...
{
    private static function utility(): ColombiaPublicUtility
    {
        return new ColombiaPublicUtility();
    }
    ...
    private static function ctx(array $over = []): ColombiaPublicContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new ColombiaPublicContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new ColombiaPublicOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof ColombiaPublicError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new ColombiaPublicOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = ColombiaPublicMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new ColombiaPublicOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = ColombiaPublicMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new ColombiaPublicOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = ColombiaPublicMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ColombiaPublicSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = ColombiaPublicMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new ColombiaPublicResponse([]),
            'result' => new ColombiaPublicResult([]),
        ]);
        [, $err] = ColombiaPublicMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new ColombiaPublicSpec([]),
            'response' => null,
            'result' => new ColombiaPublicResult([]),
        ]);
        [, $err] = ColombiaPublicMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new ColombiaPublicSpec(['step' => 's']),
            'response' => new ColombiaPublicResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new ColombiaPublicResult([]),
        ]);
        [, $err] = ColombiaPublicMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new ColombiaPublicSpec(['step' => 's']),
            'response' => new ColombiaPublicResponse(self::resp(200, ['v' => 1])),
            'result' => new ColombiaPublicResult([]),
        ]);
        [, $err] = ColombiaPublicMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new ColombiaPublicSpec(['step' => 's']),
            'response' => new ColombiaPublicResponse(self::resp(200, ['v' => 2])),
            'result' => new ColombiaPublicResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        ColombiaPublicMakeResponse::call($ctx);
    ...
    {
        $preset = new ColombiaPublicResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new ColombiaPublicSpec([]),
            'response' => new ColombiaPublicResponse([]),
            'result' => new ColombiaPublicResult([]),
        ...
        [$got, $err] = ColombiaPublicMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new ColombiaPublicResult([])]);
        [, $err] = ColombiaPublicMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new ColombiaPublicSpec([]), 'result' => null]);
        [, $err] = ColombiaPublicMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ColombiaPublicSpec(['step' => 's']),
            'result' => new ColombiaPublicResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new ColombiaPublicOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ColombiaPublicMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new ColombiaPublicSpec(['step' => 's']),
            'result' => new ColombiaPublicResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new ColombiaPublicOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = ColombiaPublicMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new ColombiaPublicResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new ColombiaPublicSpec([]),
            'result' => new ColombiaPublicResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = ColombiaPublicMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ColombiaPublicMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new ColombiaPublicError('boom', 'boom');
        $utility->fetcher = function (ColombiaPublicContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ColombiaPublicSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = ColombiaPublicMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (ColombiaPublicContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = ColombiaPublicMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(ColombiaPublicResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        ColombiaPublicMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (ColombiaPublicContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new ColombiaPublicSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = ColombiaPublicMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new ColombiaPublicResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new ColombiaPublicSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = ColombiaPublicMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = ColombiaPublicMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = ColombiaPublicMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new ColombiaPublicResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, ColombiaPublicDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new ColombiaPublicResult(['ok' => false])]);
        $this->expectException(ColombiaPublicError::class);
        ColombiaPublicDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new ColombiaPublicResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', ColombiaPublicMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        ColombiaPublicMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new ColombiaPublicBaseFeature();
        $b = new ColombiaPublicBaseFeature();
        ColombiaPublicFeatureAdd::call($ctx, $a);
        ColombiaPublicFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): ColombiaPublicBaseFeature
    {
        $f = new ColombiaPublicBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        ColombiaPublicFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): ColombiaPublicContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new ColombiaPublicSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = ColombiaPublicPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        ColombiaPublicPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new ColombiaPublicResponse(['headers' => null]),
            'result' => new ColombiaPublicResult([]),
        ]);
        ColombiaPublicResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        ColombiaPublicResultBody::call($ctx);
