...
// ColombiaPublic SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = ColombiaPublicOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(ColombiaPublicOmni::structfix($now, Struct::undef()))
                        !== json_encode(ColombiaPublicOmni::structfix($val, Struct::undef()))) {
