...
// ColombiaPublic SDK utility: fetcher

class ColombiaPublicFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ColombiaPublicSDK/1.0)';
    ...
    public static function call(ColombiaPublicContext $ctx, string $fullurl, array $fetchdef): array
    {
