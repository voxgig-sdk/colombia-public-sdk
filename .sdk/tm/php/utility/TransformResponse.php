...
// ColombiaPublic SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class ColombiaPublicTransformResponse
{
    public static function call(ColombiaPublicContext $ctx): mixed
    {
        ...
        $transform = ColombiaPublicHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
