...
// ColombiaPublic SDK timeout feature
...
class ColombiaPublicTimeoutFeature extends ColombiaPublicBaseFeature
{
    ...
    private function _with_timeout(ColombiaPublicContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ColombiaPublicContext $_ctx, float $ms): void
    {
        $client = $this->client;
