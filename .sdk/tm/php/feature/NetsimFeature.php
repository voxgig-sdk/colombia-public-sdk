...
// ColombiaPublic SDK netsim feature
...
class ColombiaPublicNetsimFeature extends ColombiaPublicBaseFeature
{
    ...
    private function _simulate(ColombiaPublicContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(ColombiaPublicContext $ctx, array $applied): void
    {
        $client = $this->client;
