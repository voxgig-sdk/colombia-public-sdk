...
// ColombiaPublic SDK metrics feature
...
class ColombiaPublicMetricsFeature extends ColombiaPublicBaseFeature
{
    ...
    private function _record(ColombiaPublicContext $ctx, bool $ok): void
    {
