...
|---|---|---|
| `ts/` | @voxgig-sdk/colombia-public-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/colombia-public-sdk \
      --repository voxgig-sdk/colombia-public-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/colombia-public-sdk` shows it, and
`npm trust revoke @voxgig-sdk/colombia-public-sdk --id=<id>` removes it.
